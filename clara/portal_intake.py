...
def task_prompt(claim, messages, source_files=None):
    ...
    prompt = (
        ...
        'For the OneDrive filing step load onedrive-filing: find the existing client folder before ever '
        'creating one, upload the package into the year folder, and leave sharing the folder with the '
        'client to the staff member who reviews the closeout. '
