...
def task_prompt(claim, messages, source_files=None):
    ...
    prompt = (
        ...
        'your work, in which case close it with its normal close control without discarding unsaved work that '
        'is not yours. Before finishing, close every window you opened for this task.\n\n'
