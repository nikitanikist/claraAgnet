# Current validation: 0.2.3 · 12 September 2026
...
- The native Claude SDK account on this Mac is not signed in. **No fresh live-model inference is claimed for 0.2.3.** Earlier Windows live-model results remain historical evidence, not validation of every new feature.
