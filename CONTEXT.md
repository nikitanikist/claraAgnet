...
1. At idle, install the leftover-rule revision, set `windows_handoff.qualified: true` in `%LOCALAPPDATA%\Clara\portal.json`, and restart Clara (`.\Set-ClaraAutostart.ps1 -Disable`, `Stop-ScheduledTask -TaskName Clara-S-1-5-21-1046630959-3975722937-3647023733-1650`, stop the python process, `.\Set-ClaraAutostart.ps1 -Start`).
