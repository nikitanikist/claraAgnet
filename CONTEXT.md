...
| --- | --- |
| Clara GitHub integration branch | `8019e47b27b26653c041b0d27c548abff96c62a0` (16 Sep 2026); 408 tests pass, 4 skipped |
| Windows installed Clara | `8019e47b27b26653c041b0d27c548abff96c62a0` (installed 16 Sep 06:36 UTC / 12:06 IST; single `python` process 41912, autostart re-enabled). Every commit below is installed. `%LOCALAPPDATA%\Clara\portal.json` now has **`windows_handoff.qualified: true`** (set 06:38 UTC): automatic release after a verified closeout is on |
...
1. Done on 16 Sep: leftover-rule revision installed, `windows_handoff.qualified: true`, Clara restarted. To change the flag again, stop Clara first (`.\Set-ClaraAutostart.ps1 -Disable`, `Stop-ScheduledTask -TaskName Clara-S-1-5-21-1046630959-3975722937-3647023733-1650`, stop the python process, edit `portal.json`, `.\Set-ClaraAutostart.ps1 -Start`).
