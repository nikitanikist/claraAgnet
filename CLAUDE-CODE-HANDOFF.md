...
| --- | --- |
| Clara integration source | `6696200` on `feat/clearhouse-portal-v1`; 429 tests pass |
| Windows installed code | `ba4ed36` (16 Sep ~08:45 UTC; live desktop, ProFile); `windows_handoff.qualified: true`; `6696200` (observer false positives) awaiting install |
